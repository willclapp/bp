...
var hearing = make_question("Have you ever been diagnosed with hearing loss or hearing related difficulties?", hearing_options.join(''))
...
var music_options = [
    html_input({ type: 'radio', name: 'music', id: 'pro', label: 'I am a professional musician.'}),
    html_input({ type: 'radio', name: 'music', id: 'student', label: 'I am a full-time music student.'}),
    html_input({ type: 'radio', name: 'music', id: 'hobby', label: 'I am an amateur musician.'}),
    html_input({ type: 'radio', name: 'music', id: 'no-music', label: 'I am not a musician.'}),
    html_input({ type: 'radio', name: 'music', id: 'no-answer', label: 'Prefer not to say.'}),

]

var music = make_question("Do you identify as a musician?", music_options.join(''))
