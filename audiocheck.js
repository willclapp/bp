let preload_audiocheck = [
    './audio/misc/balloon.wav'
];

// let audio_check = {
//     type: 'survey-text',
//     preamble: `<audio src="./audio/misc/balloon.wav" controls>Your browser does not support the <code>audio</code> element.</audio></audio>`,
//     questions: [
//         {prompt: 'What word did you hear?', rows: 1, name: 'word_input'}
//     ],
//     on_finish: function(data) {
//         let answer = data.responses.substring(15,data.responses.length-2)
//         // answer = answer
//         answer = answer.toLowerCase().replace(/[.,\/#!$%<>\^&\"\*;:{}=\-_`~()]/g,"")
//         console.log(answer)
//         if (answer=='balloon' | answer=='baloon' | answer=='ballon'| answer=='balon'| answer=='bulloon' | answer=='buloon' | answer=='bullon'| answer=='bulon'| answer=='belloon' | answer=='beloon' | answer=='bellon'| answer=='belon'| answer=='bolloon' | answer=='boloon' | answer=='bollon'| answer=='bolon'| answer=='billoon' | answer=='biloon' | answer=='billon'| answer=='bilon'| answer=='ballun' | answer=='balun') {
